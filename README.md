...
- **드래그 앤 드롭**으로 이미지를 폴더에 추가할 수 있습니다:
  - 갤러리 이미지를 **사이드바 폴더로 드래그** → 해당 폴더에 추가
  - 여러 이미지를 선택한 상태에서 드래그하면 **선택된 모든 이미지**가 폴더에 추가됩니다.
...
- **업로드**: 이미지를 드래그 앤 드롭하거나 업로드 버튼으로 추가하면, 자동 태깅 후 LanceDB에 메타데이터와 이미지 벡터가 저장됩니다.
  - **폴더를 선택한 상태**에서 외부 이미지를 드래그 앤 드롭하면, 업로드와 동시에 **해당 폴더에 자동 추가**됩니다.
...
- **폴더**: 왼쪽 사이드바에서 폴더를 만들고, 이미지를 폴더에 넣어 관리할 수 있습니다.
  - 갤러리 이미지를 **사이드바 폴더로 드래그**하면 해당 폴더에 추가됩니다.
  - 여러 이미지를 선택(Ctrl+클릭)한 뒤 드래그하면 **선택된 모든 이미지**를 한 번에 폴더에 추가할 수 있습니다.
